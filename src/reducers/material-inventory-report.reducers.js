...
export function materialInventoryReport(state = initialState, action) {
  switch (action.type) {
    case types.MATERIAL_INVENTORY_REPORT.INIT.SUCCESS:
    ...
    case types.MATERIAL_INVENTORY_REPORT.SEARCH.SUCCESS:
